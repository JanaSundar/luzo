...
export function createConditionCompletedSnapshot(params: {
  base: StepSnapshot;
  variables: Record<string, unknown>;
  ...
  return {
    ...
    conditionDecision: {
      ...
      ...(params.resolvedValue !== undefined ? { resolvedValue: params.resolvedValue } : {}),
      chosenHandleId: params.chosenHandleId,
      chosenRouteId: params.chosenRouteId,
      chosenTargetNodeId: params.chosenTargetNodeId,
      skippedRouteIds: params.skippedRouteIds,
      error: params.error,
    },
  };
}
